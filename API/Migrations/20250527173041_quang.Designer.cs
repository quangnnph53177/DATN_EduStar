...
namespace API.Migrations
{
    ...
    [Migration("20250527173041_quang")]
    partial class quang
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Attendance", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Attendan__3214EC07B5C5ABA7");
            ...
            modelBuilder.Entity("API.Models.AttendanceDetail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Attendan__3214EC07F7A7BC5B");
            ...
            modelBuilder.Entity("API.Models.AttendanceDetailsComplaint", b =>
                {
                    ...
                    b.HasKey("ComplaintId")
                        .HasName("PK__Attendan__740D898FFAF8FE6D");
            ...
            modelBuilder.Entity("API.Models.Auditlog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__auditlog__3214EC0758574D22");
            ...
            modelBuilder.Entity("API.Models.Class", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Classes__3214EC07FD6ABBBE");
            ...
            modelBuilder.Entity("API.Models.ClassChange", b =>
                {
                    ...
                    b.HasKey("ComplaintId")
                        .HasName("PK__ClassCha__740D898F85918622");
            ...
            modelBuilder.Entity("API.Models.Complaint", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Complain__3214EC07F8F87128");
            ...
            modelBuilder.Entity("API.Models.DayOfWeekss", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__DayOfWee__3214EC0709D6F10E");

                    b.ToTable("DayOfWeekss", (string)null);
                });
            ...
            modelBuilder.Entity("API.Models.Permisson", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Permisso__3214EC07EC7EDBB3");
            ...
            modelBuilder.Entity("API.Models.Role", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Roles__3214EC078AFC3E58");
            ...
            modelBuilder.Entity("API.Models.Room", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Rooms__3214EC077E5856B4");
            ...
            modelBuilder.Entity("API.Models.Schedule", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Schedule__3214EC07335A7346");
            ...
            modelBuilder.Entity("API.Models.StudentsInfor", b =>
                {
                    ...
                    b.HasKey("UserId")
                        .HasName("PK__Students__1788CC4C5F39F787");
            ...
            modelBuilder.Entity("API.Models.StudyShift", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__StudyShi__3214EC07C4CACDDA");
            ...
            modelBuilder.Entity("API.Models.Subject", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Subjects__3214EC07ADBCE78F");
            ...
            modelBuilder.Entity("API.Models.User", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__User__3214EC07EE68BB21");
            ...
            modelBuilder.Entity("API.Models.UserProfile", b =>
                {
                    ...
                    b.HasKey("UserId")
                        .HasName("PK__UserProf__1788CC4C8BEB2910");

                    b.ToTable("UserProfiles");
                });

            modelBuilder.Entity("RolePermisson", b =>
                {
                    ...
                    b.HasKey("RoleId", "PermissonId")
                        .HasName("PK__RolePerm__F57FC50055398B68");

                    b.HasIndex(new[] { "PermissonId" }, "IX_RolePermisson_PermissonId");

                    b.ToTable("RolePermisson", (string)null);
                });
            ...
            modelBuilder.Entity("StudentInClass", b =>
                {
                    ...
                    b.HasKey("ClassId", "StudentId")
                        .HasName("PK__StudentI__483575793B8F90FF");
            ...
            modelBuilder.Entity("UserRole", b =>
                {
                    ...
                    b.HasKey("Userid", "Roleid")
                        .HasName("PK__UserRole__2F388C87A201A5ED");
            ...
            modelBuilder.Entity("API.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("API.Models.DayOfWeekss", "Day")
                        .WithMany("Schedules")
                        .HasForeignKey("DayId")
            ...
            modelBuilder.Entity("RolePermisson", b =>
                {
                    b.HasOne("API.Models.Permisson", null)
                        .WithMany()
